You are the orchestrator of a parallel implementation effort. This is a git repo
(`directory-demo`) on branch `main`. Phase 3 dispatched three tasks concurrently
